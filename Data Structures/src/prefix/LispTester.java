...
public class LispTester {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("result:" + LispEvaluator.evaluate("(/ 9 9)"));
	  
	//System.out.println("1. result:" + LispEvaluator.evaluate("(*)"));
	  
	//System.out.println("2. result:" + LispEvaluator.evaluate("(/ 0)"));
